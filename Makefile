...
# for web failsafe mode, added by mleaf Sun 9th 2015
LIBS += lib_lwip/liblwip.a
LIBS += lwip_app/liblwipapp.a
...
clean:
	...
	rm -f ./uboot.bin ./uboot.img ./u-boot ./u-boot.* ./uboot_a.bin ./System.map ./uboot-web.bin
