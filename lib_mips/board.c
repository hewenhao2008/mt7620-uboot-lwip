...
/* enter web failsafe mode, added by Mleaf, NOV 11st 2014 */
		int counter = 0;
		// wait 0,5s
		udelay(500000);
		printf( "-----------------------------------------------------\n");
		...
		printf( "|       |.-----.-----.-----.|  |  |  |.----.|  |_\n");
		printf( "|   -   ||  _  |  -__|     ||  |  |  ||   _||   _|\n");
		printf( "|_______||   __|_____|__|__||________||__|  |____|\n");
		printf( "         |__| W I R E L E S S   F R E E D O M\n");
		printf( "-----------------------------------------------------\n");
		printf( " Mleaf Web FailSafe Uboot (1.01)\n");
		printf( " Author: Mleaf_HeXi 350983773@qq.com or mleaf90@gmail.com\n");
		printf( " Date:   2014-12-02\n");
		printf( "-----------------------------------------------------\n");

		printf( "\nPress press WPS button for more than 4 seconds to run web failsafe mode\n\n" );
		...
		if ( counter > 0 ) {
			...
			printf( "\n\n Welcome to HeXi made for MT7620 WebSafe Uboot \n Please set computer ip addr 192.168.1.100\n Please set computer ip netmask 255.255.255.0\n", counter );
			printf( "\n\n If you have any problem with this UBOOT \n Please contact 350983773@qq.com\n\n", counter );
